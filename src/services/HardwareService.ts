...
export class HardwareService {
    ...
    public async getHardware(id:string): Promise<HardwareModel[]> {
        return (await beAxios('api/hardwares/'+id, {
            params: {
                format: 'json',
            },
            headers:{
    ...
    public async getHardwareByPage(pageNumber: number, pageSize: number, fullText: boolean): Promise<PaginationContainer<HardwareModel>> {
